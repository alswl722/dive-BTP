...
export default async function ProgramsPage() {
  ...
  const [programs, companies] = await Promise.all([listPrograms(), listCompanies()]);
  ...
  return (
    ...
    <ProgramsExplorer programs={programs} companies={companies} referenceDateIso={referenceDateIso} />
  );
}
